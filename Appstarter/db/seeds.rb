...
u1.projects.create!(name: 'Moon landing', creator: 'Amstrong co.', description: 'Lorem ipsum dolor esset', image: 'https://ksr-ugc.imgix.net/projects/1950682/photo-original.jpg?v=1435699216&w=218&h=162&fit=crop&auto=format&q=92&s=8fd69b8ad600741bc99f0d61e9a444a6', goal: 100000000000, user_id: 1)

u2.projects.create!(name: 'Everest Cruise', creator: 'Schettino co.', description: 'Lorem ipsum dolor esset', image: 'http://thetraveljam.com/wp-content/uploads/2015/01/Miky-in-Norway-Geiranger.jpg', goal: 300000000, user_id: 1)